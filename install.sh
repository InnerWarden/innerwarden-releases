...
echo ""
echo "  Guarding an AI agent in production? Kernel-level enforcement for Linux"
echo "  hosts (Active Defence) is available: https://www.innerwarden.com/#early-access"
echo ""
